...
import SanitaryPadInstructions from './SanitaryPadInstructions';
import MenstrualCupInstructions from './MenstrualCupInstructions';
import TamponInstructions from './TamponInstructions.jsx';
		...
		<>
			...
			<BrowserRouter>
				<Routes>
					...
					<Route path="/sanitarypad-instructions" element={<SanitaryPadInstructions />} />
                    <Route path="/menstrualcup-instructions" element={<MenstrualCupInstructions />} />
					<Route path="/tampon-instructions" element={<TamponInstructions />} />
